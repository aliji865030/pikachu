...
//     let result = parsedResponse.results[i].name;
...
//   const pokemonList =
//     parsedResponse.pokemon.length > 20 ? 20 : parsedResponse.pokemon.length;
...
//     image.src = parsedResponse2.sprites.front_default;
...
//      for(let imageName in storeByPokemonName){
//         let div = document.createElement("div");
        
//     let image = document.createElement("img");
//     image.src = storeByPokemonName[imageName]
//     image.alt=imageName
//     console.log(storeByPokemonName[imageName]);

//      document.querySelector(".content").append(image)
//     let span = document.createElement("span");
//     span.innerText = i++;

//     div.append(span, image);
...
// // Object.keys(storeByPokemonName).forEach(function(key) {
...
// // console.log(searchPokemonByName[raticate]);
